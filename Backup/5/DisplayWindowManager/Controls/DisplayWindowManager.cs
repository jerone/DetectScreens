...
namespace DisplayWindowManager.Controls
{
	...
	public partial class DisplayWindowManager : UserControl
	{
		...
		{
			//Debug.WriteLine(SystemInformation.WorkingArea);
			//Debug.WriteLine(SystemInformation.VirtualScreen);
			//Debug.WriteLine(SystemInformation.ScreenOrientation);
...
#if DEBUG
			e.Graphics.DrawRectangle(new Pen(Color.Yellow), _offset.X, _offset.Y, (Int32)(_workingArea.Width * Scale)-1, (Int32)(_workingArea.Height * Scale)-1);
#endif
		}
