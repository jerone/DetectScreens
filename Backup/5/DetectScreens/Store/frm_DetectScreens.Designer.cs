...
namespace DetectScreens.Store
{
	partial class FrmDetectScreens
	{
		...
		private void InitializeComponent()
		{
			...
			this.displayWindowManager = new DisplayWindowManager.Controls.DisplayWindowManager();
			...
			this.btnResolution.Click += new System.EventHandler(BtnResolutionClick);
			// 
			// lblVersionInfo
			// 
		...
		private DisplayWindowManager.Controls.DisplayWindowManager displayWindowManager;
